...
function addSession {
 ...
 addSession "NEO" "ssh querzion@192.168.0.13"
 addSession "ONEv1" "ssh root@192.168.0.62"
 addSession "ONEv2" "ssh querzion@192.168.0.86:22"
 addSession "lolMiner" "cd ~/ArchTitus/Extras/lolMiner_1.36/ && ./mine_eth.sh"
